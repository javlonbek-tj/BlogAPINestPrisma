/*
  ...
  - Added the required column `activationCodeExpires` to the `User` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE "User" DROP COLUMN "activationLink",
ADD COLUMN     "activationCode" TEXT NOT NULL,
ADD COLUMN     "activationCodeExpires" BIGINT NOT NULL;
